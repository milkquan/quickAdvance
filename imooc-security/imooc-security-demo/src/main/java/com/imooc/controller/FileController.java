...
import com.imooc.entity.FileInfo;
...
public class FileController {
	...
	String folder = "D:/gitSpace/quickAdvance/imooc-security/imooc-security-demo/src/main/resources/picture";
	
	@PostMapping("/upload")
	public FileInfo upload(MultipartFile file) throws Exception{
		
		logger.info("name: "+file.getName());
		logger.info("orignName: "+file.getOriginalFilename());
